    ...
    theme: {
        extend: {
            fontSize: {
                ...
                xl: ['1.25rem', { lineHeight: '1.4', letterSpacing: '0.03em', fontWeight: '700' }],
                '2xl': ['1.5rem', { lineHeight: '1.3', letterSpacing: '0.03em', fontWeight: '700' }],
                '3xl': ['1.875rem', { lineHeight: '1.2', letterSpacing: '0.04em', fontWeight: '800' }],
